...
public:
   ...
   //! types of command line options possible
   enum OptType { 
     Valueless, OptionalValue, MandatoryValue
   };
  ...
  //! adds a possible command line option to accept
  ...
  //! retrieves the value of the command line option
  ...
  //! prints usage information to string
